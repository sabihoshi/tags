...
{if;{logic;||;{bool;{length;{get;~list.username}};!=;0};{bool;{length;{get;~list.usernick}};!=;0}};
    ...
    {set;~messageid;{send;393843079393706004;{apply;embedbuild;{get;~embed}}}}
    {reactadd;393843079393706004;{get;~messageid};<:banhammer:326431867047772160> <:chess_cross:436745175294017546>}
    {set;~user;{get;~user}}
    {set;~users;{concat;{rolemembers;393744943555936260};{rolemembers;400106301826269184};{rolemembers;406828219032010762 };{rolemembers;441050979396222986};{rolemembers;507274426656489482}}}
	...
	{reactremoveall;393843079393706004;{get;~messageid}}
}