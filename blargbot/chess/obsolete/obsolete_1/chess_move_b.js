	...
	k;
		{switch;{lower;{args;2}};
			g8;	
				...
				{switch;{get;@{userid}side_2};
					0;
						{if;!=;r;{get;@{get;p}h8};:x: FATAL ERROR! Please report to tag creator. `rook not found in h8`
							{return}
						}
			...
			c8;	
				...
				{switch;{get;@{userid}side_2};
					0;
						{if;!=;r;{get;@{get;p}a8};:x: FATAL ERROR! Please report to tag creator. `rook not found in a8`
							{return}
						}
						{if;!=;true;{get;castling};:x: FATAL ERROR! Please report to tag creator. `castling is not true`
							{return}
