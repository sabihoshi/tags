...
{set;~link;{get;@chess_link1}{set;~index0;1}{set;~index1;1}{regexreplace;{repeat;{get;@{get;~p}{get;~{get;~index0}}{get;~index1}}{if;==;8;{get;~index0};{set;~index0;1}{void;{increment;~index1}};{void;{increment;~index0}}};64};/-/g;_}&p={get;@{userid}chess_sizen}&s={get;@{userid}chess_piecen}&c={get;@{userid}chess_color_darkn}{get;@{userid}chess_color_lightn}{switch;{get;@{userid}chess_coordn};;&r=FFFFFF;nc;;o;&r=FFFFFF;&r=FFFFFF}{set;~k;{if;{logic;&&;{if;!=;;{get;~{get;~p}1a};true;false};{if;!=;;{get;~{get;~p}1b};true;false}};{get;~{get;~p}1a}Q{get;~{get;~p}1b}Q0Q0Q255A}{if;{logic;&&;{if;!=;;{get;~{get;~p}2a};true;false};{if;!=;;{get;~{get;~p}2b};true;false}};{get;~{get;~p}2a}Q{get;~{get;~p}2b}{if;==;true;{get;~{get;~p}eat};Q255Q0Q0;Q0Q0Q255}}}{if;!=;;{get;~k};&k={get;~k}}&z={get;@{get;~p}tm}{if;==;b;{get;@{get;~p}tm};&f=1}}
{embed;
	{buildembed;
		author.icon_url:
			{useravatar};
